...
<?php }; ?>
  ...
  <form id='tlc-livestream-settings' class='tlc' method="POST">
    ...
    <div class=tlc>
      ...
      <div class=info>
        The YouTube channel ID is used to look for your active livestream and to discover
        and explore your playlists.  You can find your channel ID via the
        You will need to get the channel ID from your 
      ...
      <div id='tlc-playlist-info' class=info>
        You can find your playlist ID by doing the following:
        <ul>
